...
export const productCountDown = function () {
    ...
    setInterval( function () {
        for ( let i = 0; i < items.length; i++ ) {
            ...
            item.querySelector( ".product-countdown .days .countdown-amount" ).innerHTML = days;
            item.querySelector( ".product-countdown .hours .countdown-amount" ).innerHTML = ( 10 > hours ? '0' : '' ) + hours + '<b class="mr-1 ml-1">:</b>';
            item.querySelector( ".product-countdown .minutes .countdown-amount" ).innerHTML = ( 10 > minutes ? '0' : '' ) + minutes + '<b class="mr-1 ml-1">:</b>';
            item.querySelector( ".product-countdown .seconds .countdown-amount" ).innerHTML = ( 10 > seconds ? '0' : '' ) + seconds;
        }
    }, 1000 )
}
...
export const countTo = function () {
    ...
    if ( items ) {
        for ( let i = 0; i < items.length; i++ ) {
            ...
            let pt = 0;
            let height = item.parentElement.parentElement.parentElement.getBoundingClientRect().top + window.pageYOffset;
            let flag = 0;
