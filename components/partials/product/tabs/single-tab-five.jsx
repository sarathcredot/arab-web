...
export default function SingleTabFive ( props ) {
    const { adClass = "", product, isCustom = true } = props;
            ...
            <div className="skel-pro-tabs"></div>
            {
                ...
                <Tabs className={ `product-single-tabs ${adClass}` } selectedTabClassName="active" selectedTabPanelClassName="show">
                    <div className="container">
                        ...
                        {
                            isCustom && <TabPanel className="tab-pane fade">
                                <div className="mb-2 pb-2">Custom Tab Content</div>
                            </TabPanel>
                        }
                    </div>
                </Tabs>
