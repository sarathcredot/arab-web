    ...
    return (
        <div className="product-single-qty">
            <div className="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                ...
                <input className="horizontal-quantity form-control" type="number" min="1" max={ max } value={ count } onChange={ changeCount } style={{fontFamily:"Jakarta sans-serif;",fontWeight:"600"}}/>
