...
function ProductDetailFour ( props ) {
    ...
    const { prev, next, isNav = true } = props;
    const { product, adClass = "", parent = ".product-single-default" } = props;
    ...
    return (
        <>
            ...
            {
                product &&
                <div className={ `product-single-details mb-1 ${ adClass }` }>
                    <div className="single-product-custom-block">
                        <div className="porto-block">
                            <h5 className="porto-heading d-inline-block">Free Shipping</h5>

                            <h5 className="porto-heading d-inline-block">100% Money Back Guarantee</h5>

                            <h5 className="porto-heading d-inline-block">Online Support 24/7</h5>
                        </div>
                    </div>
                    ...
                    <a href="/pages/wishlist" className={ `btn-icon-wish add-wishlist justify-content-start mb-lg-0 mb-1 ${ isInWishlist() ? 'added-wishlist' : '' }` } onClick={ onWishlistClick } title={ `${ isInWishlist() === true ? 'Go to Wishlist' : 'Add to Wishlist' }` }><i
                        className="icon-wishlist-2"></i><span>Add to Wishlist</span></a>
                </div>
            }
        </>
    )
...
export default connect( mapStateToProps, { ...WishlistAction, ...CartAction } )( ProductDetailFour );