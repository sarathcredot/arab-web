...
function ShopHorizontalTwo () {
    ...
    return (
        <main className="main">
            ...
            <div className="container">
                <nav className="toolbox sticky-header horizontal-filter filter-sorts mobile-sticky mb-2 pt-3 pb-3 pb-lg-0">
                    <div className="toolbox-left">
                        ...
                        <ShopSidebarTwo adClass="d-lg-flex d-none" />
                ...
                <div className="row">
                    <ShopSidebarTwo adClass="horizontal-filter filter-sorts d-lg-none d-block" />
                    <div className="col-lg-12 main-content pt-0">
