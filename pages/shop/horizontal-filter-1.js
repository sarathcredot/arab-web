...
function ShopHorizontalOne () {
    ...
    function sidebarToggle ( e ) {
        ...
        if ( body.classList.contains( 'sidebar-opened' ) ) {
            e.currentTarget.closest( '.filter-toggle' ) && e.currentTarget.closest( '.filter-toggle' ).classList.remove( 'opened' );
            body.classList.remove( 'sidebar-opened' );
            mainContent.classList.add( 'sidebar-hidden' );
            setGrid( "col-6 col-sm-4 col-md-3" );
        } else {
            e.currentTarget.closest( '.filter-toggle' ) && e.currentTarget.closest( '.filter-toggle' ).classList.add( 'opened' );
    ...
    return (
        <main className="main">
            ...
            <div className="container">
                <nav className="toolbox sticky-header horizontal-filter mobile-sticky mb-1 pt-3 pb-3 pb-lg-0">
                ...
                <div className="row main-content-wrap sidebar-hidden">
                    <ShopSidebarOne adClass="pt-lg-0" />

                    <div className="col-lg-9 main-content pt-0">

                        <ProductsGrid products={ products } loading={ loading } perPage={ perPage } gridClass={ grid } />
...
export default withApollo( { ssr: typeof window === 'undefined' } )( ShopHorizontalOne );