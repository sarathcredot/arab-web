            ...
            <div className="container pt-2">
                <div className="row">
                    <div className="col-lg-9 main-content">
                        <OwlCarousel adClass="boxed-slider owl-carousel owl-carousel-lazy owl-theme owl-theme-light" options={ {
                            nav: false
                        } }>
                            <ShopBanner adClass="mb-2" />
                        </OwlCarousel>
...
export default withApollo( { ssr: typeof window === 'undefined' } )( ShopboxedSlider );