    ...
    return (
        <main className="main">
            ...
            <div className="shop-off-canvas">
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12 main-content pt-3">
                            <nav className="toolbox sticky-header mobile-sticky mb-lg-2">
                                <div className="toolbox-left">
                                    <a href="#" className="sidebar-toggle d-inline-flex" onClick={ e => sidebarToggle( e ) }>
                                ...
                                <div className="toolbox-right">
                                    <div className="toolbox-item toolbox-sort mb-0">
                                        <label>Sort By:</label>
                                    ...
                                    <div className="toolbox-item toolbox-show mb-0">
                                        <label>Show:</label>
                                    ...
                                    <div className="toolbox-item layout-modes mb-0">
                            ...
                            <ProductsGrid products={ products } loading={ loading } perPage={ perPage } gridClass="col-6 col-sm-4 col-md-3" />
...
export default withApollo( { ssr: typeof window === 'undefined' } )( OffCanvas );