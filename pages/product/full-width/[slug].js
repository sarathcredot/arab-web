...
function ProductFullWidth () {
    ...
    return (
        <main className="main">
            ...
            <div className={ `product-single-container product-single-default product-full-width skeleton-body skel-shop-products pt-2 ${loading ? '' : 'loaded'}` } style={ { minHeight: '1000px' } }>
            ...
            <div className={ `container-fluid skeleton-body skel-shop-products ${loading ? '' : 'loaded'}` }>
                <RelatedProducts adClass="border-0" products={ related } loading={ loading } />
            </div>
