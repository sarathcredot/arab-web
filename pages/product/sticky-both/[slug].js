...
function ProductStickyBoth () {
    ...
    return (
        <main className="main">
                ...
                <div className={ `product-single-container product-single-default product-both-info` }>
                    {
                        ...
                        <div className="product-single-details">
                            ...
                            <div className="ratings-container">
                                ...
                                <a href="#" className="rating-link">( { product.reviews > 0 ? `${ product.reviews } Reviews` : 'There are no reviews yet.' } )</a>
                            </div>
                ...
                <div className="container">
                    ...
                    <div className="align-items-center row mb-0">
                        <div className="col-md-4 col-sm-6">
                            ...
                            <h3 className="heading border-0"><strong>ADVANCED SOUND</strong></h3>
            ...
            <RelatedProducts adClass={ `skeleton-body skel-shop-products border-0 ${ loading ? '' : 'loaded' }` } products={ related } loading={ loading } isContainer={ true } />
