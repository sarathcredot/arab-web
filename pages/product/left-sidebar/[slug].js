        ...
        <main className="main">
            ...
            <div className="container pt-2">
                <div className="row">
                    ...
                    <div className={ `col-lg-9 main-content pb-2 pt-0 skeleton-body skel-shop-products ${loading ? '' : 'loaded'}` }>
                        <div className="product-single-container product-single-default product-left-sidebar pt-0">
                            <div className="row">
                        ...
                        <RelatedProducts adClass="mb-1 border-0" products={ related } loading={ loading } />
                    </div>
                </div>
